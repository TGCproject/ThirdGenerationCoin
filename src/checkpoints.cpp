...
namespace Checkpoints
{
  ...
  // ThirdGenerationCoin: synchronized checkpoint (centrally broadcasted)
  ...
  // ThirdGenerationCoin: get last synchronized checkpoint
  ...
  // ThirdGenerationCoin: only descendant of current sync-checkpoint is allowed
...
// ThirdGenerationCoin: sync-checkpoint master key
...
// ThirdGenerationCoin: verify signature of sync-checkpoint message
...
// ThirdGenerationCoin: process synchronized checkpoint
