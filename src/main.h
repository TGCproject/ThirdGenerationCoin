...
static const int64 MAX_MINT_PROOF_OF_BURN = 200 * COIN;
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_TGC = 44;
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 180; // 180 second block spacing 
...
static const uint256 hashGenesisBlockOfficial("0x00000fcb4abc6ddcd785ddefea85057ee76f044ea8f10ea938fe122959cedf33");
...
//Burn addresses
const CBitcoinAddress burnOfficialAddress("Tn5u46vuPfbdDJ2C154ysidVUXEn6jDtyC");
const CBitcoinAddress burnTestnetAddress("mmTGCoinTestnetBurnAddress1XU5fu");

#define BURN_CONSTANT      .01 * CENT

//The hash of a burnt tx doubles smoothly over the course of 50000.0 blocks, 
// do not change this without changing BURN_DECAY_RATE (keep floating point)
#define BURN_HASH_DOUBLE   50000.0 
...
public:
  ...
  {
    // ThirdGenerationCoin: the coin stake transaction is marked with the first output empty
  ...
  */
  ...
  bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // ThirdGenerationCoin: get transaction coin age
...
public:
  ...
  // ThirdGenerationCoin: block signature - signed by coin base txout[0]'s owner
  ...
  // ThirdGenerationCoin: entropy bit for stake modifier if chosen by modifier
  ...
  // ThirdGenerationCoin: three types of block: proof-of-work, proof-of-stake, or proof-of-burn
  ...
  // ThirdGenerationCoin: get max transaction timestamp
  ...
  bool AcceptBlock();
  bool GetCoinAge(uint64& nCoinAge) const; // ThirdGenerationCoin: calculate total coin age spent in block
...
public:
  ...
  unsigned int nFile;
  unsigned int nBlockPos;
  CBigNum bnChainTrust; // ThirdGenerationCoin: trust score of block chain
  int nHeight;
  int64 nMint;
  int64 nMoneySupply;

  unsigned int nFlags;  // ThirdGenerationCoin: block index flags
