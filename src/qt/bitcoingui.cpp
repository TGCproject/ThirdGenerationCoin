/*
 * Qt4 ThirdGenerationCoin GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The ThirdGenerationCoin Developers 2011-2013
 */
...
{
  resize(850, 550);
  setWindowTitle(tr("ThirdGenerationCoin Wallet"));
#ifndef Q_WS_MAC
  setWindowIcon(QIcon(":icons/ThirdGenerationCoin"));
#else
...
void BitcoinGUI::createActions()
{
  ...
  sendCoinsAction->setToolTip(tr("Send coins to a ThirdGenerationCoin address"));
  sendCoinsAction->setCheckable(true);
  sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
  tabGroup->addAction(sendCoinsAction);

  burnCoinsAction = new QAction(QIcon(":/icons/burn"), tr("&"BURN_COINS_DIALOG_NAME), this);
  burnCoinsAction->setToolTip(tr("Burn coins from a ThirdGenerationCoin address"));
  ...
  aboutAction = new QAction(QIcon(":/icons/ThirdGenerationCoin"), tr("&About %1").arg(qApp->applicationName()), this);
  aboutAction->setToolTip(tr("Show information about ThirdGenerationCoin"));
  aboutAction->setMenuRole(QAction::AboutRole);
  aboutQtAction = new QAction(tr("About &Qt"), this);
  aboutQtAction->setToolTip(tr("Show information about Qt"));
  aboutQtAction->setMenuRole(QAction::AboutQtRole);
  optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
  optionsAction->setToolTip(tr("Modify configuration options for ThirdGenerationCoin"));
  optionsAction->setMenuRole(QAction::PreferencesRole);
  toggleHideAction = new QAction(QIcon(":/icons/ThirdGenerationCoin"), tr("Show/Hide &ThirdGenerationCoin"), this);
  toggleHideAction->setToolTip(tr("Show or hide the ThirdGenerationCoin window"));
...
#ifndef Q_WS_MAC
      setWindowIcon(QIcon(":icons/ThirdGenerationCoin_testnet"));
#else
      MacDockIconHandler::instance()->setIcon(QIcon(":icons/ThirdGenerationCoin_testnet"));
#endif
      if(trayIcon)
      {
...
void BitcoinGUI::createTrayIcon()
{
  ...
  trayIcon->setToolTip(tr("ThirdGenerationCoin client"));
  ...
  notificator = new Notificator(tr("ThirdGenerationCoin-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
  ...
  labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ThirdGenerationCoin network", "", count));
}
