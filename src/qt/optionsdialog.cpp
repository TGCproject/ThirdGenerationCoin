        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start ThirdGenerationCoin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start ThirdGenerationCoin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the ThirdGenerationCoin client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show ThirdGenerationCoin addresses in the transaction list"));
